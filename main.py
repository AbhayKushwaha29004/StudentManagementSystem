def addstudent():
    ...
    mobileentry = Entry(
        addroot, font=("roman", 15, "bold"), bd=5, textvariable=mobileval
    )
    ...
    addressentry = Entry(
        addroot, font=("roman", 15, "bold"), bd=5, textvariable=addressval
    )
    addressentry.place(x=250, y=250)

    genderentry = Entry(
        addroot, font=("roman", 15, "bold"), bd=5, textvariable=genderval
    )
...
def searchstudent():
    ...
    nameentry = Entry(
        searchroot, font=("roman", 15, "bold"), bd=5, textvariable=nameval
    )
    nameentry.place(x=250, y=70)

    mobileentry = Entry(
        searchroot, font=("roman", 15, "bold"), bd=5, textvariable=mobileval
    )
    mobileentry.place(x=250, y=130)

    emailentry = Entry(
        searchroot, font=("roman", 15, "bold"), bd=5, textvariable=emailval
    )
    emailentry.place(x=250, y=190)

    addressentry = Entry(
        searchroot, font=("roman", 15, "bold"), bd=5, textvariable=addressval
    )
    addressentry.place(x=250, y=250)

    genderentry = Entry(
        searchroot, font=("roman", 15, "bold"), bd=5, textvariable=genderval
    )
    genderentry.place(x=250, y=310)
    ...
    dateentry = Entry(
        searchroot, font=("roman", 15, "bold"), bd=5, textvariable=dateval
    )
...
def updatestudent():
    ...
    nameentry = Entry(
        updateroot, font=("roman", 15, "bold"), bd=5, textvariable=nameval
    )
    nameentry.place(x=250, y=70)

    mobileentry = Entry(
        updateroot, font=("roman", 15, "bold"), bd=5, textvariable=mobileval
    )
    mobileentry.place(x=250, y=130)
    ...
    addressentry = Entry(
        updateroot, font=("roman", 15, "bold"), bd=5, textvariable=addressval
    )
    addressentry.place(x=250, y=250)

    genderentry = Entry(
        updateroot, font=("roman", 15, "bold"), bd=5, textvariable=genderval
    )
    genderentry.place(x=250, y=310)
    ...
    dateentry = Entry(
        updateroot, font=("roman", 15, "bold"), bd=5, textvariable=dateval
    )
    dateentry.place(x=250, y=430)
...
def exportstudent():
    ...
    for i in gg:
        ...
        pp = content["values"]
        id.append(pp[0]), name.append(pp[1]), mobile.append(pp[2]), email.append(
            pp[3]
        ), address.append(pp[4]), gender.append(pp[5]),
    ...
    df = pandas.DataFrame(
        list(zip(id, name, mobile, email, address, gender, dob, addeddate, addedtime)),
        columns=dd,
    )
...
def Connectdb():
    ...
    passwordentry = Entry(
        dbroot, font=("roman", 15, "bold"), bd=5, textvariable=passwordval
    )
...
style = ttk.Style()
style.configure(
    "Treeview.Heading", font=("Comic Sans MS", 15, "bold"), foreground="blue"
)
style.configure(
    "Treeview", font=("times", 15, "bold"), background="cyan", foreground="black"
)
scroll_x = Scrollbar(ShowDataFrame, orient=HORIZONTAL)
scroll_y = Scrollbar(ShowDataFrame, orient=VERTICAL)
studenmttable = Treeview(
    ShowDataFrame,
    columns=(
        "Id",
        "Name",
...
studenmttable.column("Id", width=40)
...
SliderLabel.place(x=266, y=0)
IntroLabelTick()
IntroLabelColorTick()
############################################################################################################### clock
clock = Label(
    root, font=("times", 12, "bold"), relief=RIDGE, borderwidth=4, bg="lawn green"
)
clock.place(x=0, y=0)
tick()
...
connectbutton = Button(
    ...
    width=23,
    font=("Comic Sans MS", 13, "italic bold"),
    relief=RIDGE,
    borderwidth=4,
    bg="green2",
    activebackground="blue",
